...
*/
    ...
    public static void main(String[] args) throws IOException { 
        ...
        for(int i=0; i<GN; i++){
            ...
            System.out.println("*** Mejor Solucion: "+ sol);
        }
...
Cosas por hacer:
* Crear interfaz de menu para solicitar los valores de las variables generales
* Guardar la info en un archivo
* Llevar un cronometro de tiempo de ejecucion
